      ...
      {loading ? (
        ...
        <>
          <div className="grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', marginBottom: '3rem' }}>
            <KPICard icon={Users} title="Taxa de Ocupação" value={`${Math.round((stats.total_atendimentos / 200) * 100)}%`} color="#2dd4bf" infoKey="taxa_ocupacao" />
          ...
          <div className="grid">
            <div className="glass-card" style={{ padding: '2rem', height: '400px' }}>
              <h3 style={{ marginBottom: '2rem' }}>Tendência de Ocupação</h3>
            ...
            <div className="glass-card" style={{ padding: '2rem', height: '400px', display: 'flex', flexDirection: 'column' }}>
              <h3 style={{ marginBottom: '2rem' }}>Distribuição de Reinternação (30 dias)</h3>
              <ResponsiveContainer width="100%" height="80%">
                <PieChart>
